...
train_index_exp_3 = [ 0,  1,  3,  5,  6,  7,  8, 10, 11, 12, 14, 15, 16, 17, 18]
val_index_exp_3 = [2, 4, 9, 13, 19]

train_files_exp_3 = [csv_files[i] for i in train_index_exp_3]
val_files_exp_3 = [csv_files[i] for i in val_index_exp_3]
...
X_train, y_train = load_from_list(train_files_exp_3)
X_val, y_val = load_from_list(val_files_exp_3)
...
dump(pipeline, '../models/modelExp3.joblib')
