...
train_index_exp_4 = [ 0,  1,  2,  3,  4, 5,  8,  9, 11, 13, 15, 16, 17, 18, 19]
val_index_exp_4 = [6, 7, 10, 12, 14]

train_files_exp_4 = [csv_files[i] for i in train_index_exp_4]
val_files_exp_4 = [csv_files[i] for i in val_index_exp_4]
...
X_train, y_train = load_from_list(train_files_exp_4)
X_val, y_val = load_from_list(val_files_exp_4)
...
dump(pipeline, '../models/modelExp4.joblib')
