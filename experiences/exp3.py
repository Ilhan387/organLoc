...
val_files_3D_exp_3 = [files3D[i] for i in val_index_exp_3]

# Chargement du modèle
pipeline = load('../models/modelExp3.joblib')
...
for file in (val_files_3D_exp_3):
    img = nib.load(file)
    affine = img.affine
...
patients_ids = extract_ids(val_files_3D_exp_3)
...
plot_organ_distance_errors(stats, title="Résultats exp3", run_label="Run exp3")
