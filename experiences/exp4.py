...
val_index_exp_4 = [6, 7, 10, 12, 14]

val_files_3D_exp_4 = [files3D[i] for i in val_index_exp_4]

# Chargement du modèle
pipeline = load('../models/modelExp4.joblib')
...
for file in (val_files_3D_exp_4):
    img = nib.load(file)
    affine = img.affine
...
patients_ids = extract_ids(val_files_3D_exp_4)
...
errors_patient_132 = compute_errors(true_centers_patient_1, estimated_centers_patient_1)
errors_patient_133 = compute_errors(true_centers_patient_2, estimated_centers_patient_2)
errors_patient_134 = compute_errors(true_centers_patient_3, estimated_centers_patient_3)
errors_patient_135 = compute_errors(true_centers_patient_4, estimated_centers_patient_4)
errors_patient_136 = compute_errors(true_centers_patient_5, estimated_centers_patient_5)
...
plot_organ_distance_errors(stats, title="Résultats exp 4", run_label="Run exp4")
