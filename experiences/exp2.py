...
val_files_3D_exp_2 = [files3D[i] for i in val_index_exp_2]

# Chargement du modèle
pipeline = load('../models/modelExp2.joblib')
...
for file in (val_files_3D_exp_2):
    img = nib.load(file)
    affine = img.affine
...
patients_ids = extract_ids(val_files_3D_exp_2)
...
plot_organ_distance_errors(stats, title="Résultats exp2", run_label="Run exp2")
